...
public class Streaming2ColumnFormatFile {
    public static void main(String[] args) throws Exception {
        ...
        //每次ck之间的间隔，不会重叠
        checkpointConfig.setMinPauseBetweenCheckpoints(200L);
        //每次ck的超时时间
        checkpointConfig.setCheckpointTimeout(200L);
        //如果ck执行失败，程序是否停止
...
//        DataStreamSource<String> socket = env.fromElements("a", "b", "c");
...
//        input.print();
        ...
        StreamingFileSink streamingFileSink = StreamingFileSink.forBulkFormat(new Path("file:///Users/luwang/Desktop/testwordcount/data/file"),
