 ...
 */
@PublicEvolving
public class BeanPathBucketAssigner<IN> implements BucketAssigner<IN, String> {
    ...
    public BeanPathBucketAssigner(String storeLevel, String formatString, ZoneId zoneId ){
        this.formatString = Preconditions.checkNotNull(formatString);
        this.zoneId = Preconditions.checkNotNull(zoneId);
        this.storeLevel = Preconditions.checkNotNull(storeLevel);
    }

    /**
     * Creates a new {@code DateTimeBucketAssigner} with format string {@code "yyyy-MM-dd--HH"}.
     */
    public BeanPathBucketAssigner() {
     ...
     *                     the bucket id.
     */
    public BeanPathBucketAssigner(String formatString) {
     ...
     */
    public BeanPathBucketAssigner(ZoneId zoneId) {
     ...
     * @param zoneId The timezone used to format {@code DateTimeFormatter} for bucket id.
     */
    public BeanPathBucketAssigner(String formatString, ZoneId zoneId) {
        this.formatString = Preconditions.checkNotNull(formatString);
        this.zoneId = Preconditions.checkNotNull(zoneId);
    }
    ...
    public String getBucketId(IN element, BucketAssigner.Context context) {
        ...
        String format = dateTimeFormatter.format(Instant.ofEpochMilli(context.currentProcessingTime()));

        StringBuilder sb = new StringBuilder();
        sb.append(storeLevel).append("_").append(StringUtil.camel2under(classSimpleName)).append("/").append(format);
        return sb.toString();
    }
