...
import com.zkdn.file.HainiuParquetPojo;
 ...
 *
 * @Auther: lw
 * @Date: 2022-03-03-9:54 上午
 * @Description:
 */
public class AccessShopDwdKafka2HDFS {
    public static void main(String[] args) throws Exception {
        ...
        FlinkKafkaConsumer010<String> shopKafkaInput = new FlinkKafkaConsumer010<String>(MyConfig.KAFKA_TOPIC_ACCESS_SHOP_DWD, new SimpleStringSchema(), kafkaConsumerProps);
        shopKafkaInput.setStartFromLatest();
        DataStreamSource<String> shopKafkaSource = env.addSource(shopKafkaInput);

        SingleOutputStreamOperator<AccessModel> process = shopKafkaSource.filter(new FilterFunction<String>() {
            @Override
        ...
        BeanPathBucketAssigner<AccessModel> bucketAssigner = new BeanPathBucketAssigner<>("dwd_shop", "yyyy/MMdd/HH", ZoneId.of("Asia/Shanghai"));
